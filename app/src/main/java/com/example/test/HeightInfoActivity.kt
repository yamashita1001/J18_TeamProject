...
class HeightInfoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val saveButton = findViewById<Button>(R.id.saveHeightButton)
...
//        loadBodyInfo(ageInput, heightInput, weightInput)
        ...
        saveButton.setOnClickListener {
            ...
            if (height != null) {
                ...
                val intent = Intent(this, WeightInfoActivity::class.java) //体重登録に遷移
    ...
    // 身体情報を保存
    private fun saveBodyInfo(height: Float) {
